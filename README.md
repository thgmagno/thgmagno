...
Falando em habilidades técnicas, meu foco está em JavaScript e TypeScript. Possuo sólida experiência em ferramentas como React, Next.js, Node.js e Nest.js, sempre adicionando um toque de estilo com o Tailwind CSS. Essa combinação reflete minha paixão por criar soluções modernas e eficientes. Se você procura alguém comprometido, que não deixa nenhum código para depois, estou aqui para somar.
